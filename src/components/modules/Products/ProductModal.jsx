                    ...
                    <div style={{ border: '1px solid #22c55e55', borderRadius: '10px', overflow: 'hidden' }}>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', padding: '12px' }}>
                            <div style={{ display: 'flex', gap: '6px', alignItems: 'flex-end' }}>
                                <div style={{ flex: 1 }}>
                                    <CurrencyInput label="Atacado — Fardo/Caixa" name="wholesalePrice" value={formData.wholesalePrice} onChange={handleChange} error={errors.wholesalePrice} placeholder="0,00" className="no-margin" />
                                </div>
                            ...
                            <CurrencyInput label="Atacado — At. Varejo" name="wholesalePrice2" value={formData.wholesalePrice2} onChange={handleChange} placeholder="0,00" className="no-margin" />
